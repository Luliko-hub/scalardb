...
public class TableSnapshotTest {
  ...
  @Test
  public void put_CalledOnce_WithTableMetadataWithClusteringKey_ShouldPutProperly() {
    // Arrange
  ...
  @Test
  public void put_CalledTwice_WithTableMetadataWithClusteringKey_ShouldPutProperly() {
    // Arrange
    TableSnapshot tableSnapshot = new TableSnapshot(getTableMetadataWithClusteringKey());
