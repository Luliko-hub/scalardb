...
public class DistributedStorageAdminService
  ...
  @Override
  public void getNamespaceNames(GetNamespaceNamesRequest request,
      StreamObserver<GetNamespaceNamesResponse> responseObserver) {
    execute(
        () -> {
          Set<String> namespaceNames = admin.getNamespaceNames();
          responseObserver.onNext(GetNamespaceNamesResponse.newBuilder().addAllNamespaceNames(namespaceNames).build());
          responseObserver.onCompleted();
        },
        responseObserver,
